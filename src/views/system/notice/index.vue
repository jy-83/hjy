    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="noticeType" width="100">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.article_type" :value="scope.row.noticeType"/>
        </template>
      </el-table-column>
...
export default {
  name: "Notice",
  dicts: ['sys_notice_status', 'article_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除所选中的知识库数据项？').then(function() {
